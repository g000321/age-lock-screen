package com.gym.agelockscan.customviews;
...
public class ColorPickerView extends View {
    boolean debug=true;
    String TAG="aa";
    private int mInitialColor=Color.BLUE;//初始颜色
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       ...
       if (mWidth==0){
        ...
        Logger.e("aaaa","heightMeasureSpec"+heightMeasureSpec+"~~widthMeasureSpec"+widthMeasureSpec);
    }
    //根据xml的设定获取宽度
